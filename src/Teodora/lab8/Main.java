...
public class Main extends Application {
    ...
    public static void divideLabels( TextField dividend,TextField divisor,Label result ){
        ...
        {
            AlertBox.display("Division to 0","You cannot divide by 0");
        }catch (NumberFormatException ne){
            AlertBox.display( "Exception catched","Invalid input" );
        }catch (Exception e){
            AlertBox.display("The e exception","Something unexpected !");
        }
    }
